      ...
      <full-page id="fullpage" ref="fullpage" :options="options">
        ...
        <div class="section">
          <div class="text-center q-pa-xs">
            <div :class="$store.state.window.windowWidth < 800 ? 'q-pt-xl' : 'q-pt-xl row wrap justify-center items-center content-center'">
  ...
  data () {
    return {
      ...
      options: {
        ...
        menu: '#menu',
        navigation: false,
        anchors: this.oi ? ['page1', 'page2', 'page3', 'page4', 'page5'] : ['page1', 'page2'],
